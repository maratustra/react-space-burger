...
- **Tests** — Jest unit tests cover all reducers (auth, constructor, ingredients, modal, order, tabs, ws) and the store; Cypress E2E covers the burger-constructor drag-and-drop and ingredient-modal flow
